			...
			return layout.Flex{}.Layout(gtx,
				...
				layout.Rigid(func(gtx C) D {
					...
					return layout.Flex{
						...
						layout.Rigid(func(gtx C) D {
							return widget.Label{}.Layout(gtx, h.textShaper, h.textFont, h.textFontSize, "95 min")
						}),
					)
				...
				layout.Rigid(func(gtx C) D {
					...
					return layout.Flex{
						...
						layout.Rigid(func(gtx C) D {
							return widget.Label{}.Layout(gtx, h.textShaper, h.textFont, h.textFontSize, "145 l")
						}),
					)
